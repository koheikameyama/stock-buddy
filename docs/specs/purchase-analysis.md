...
| 12 | 業績悪化×下落トレンド | 赤字 + 減益トレンド + 週間変化率が閾値以下（安定配当型-3%/成長投資型-5%/アクティブ型-10%） | stay → avoid |
| 13 | テクニカル全面ネガティブ | テクニカル売りシグナル強度が閾値以上（安定配当型60%/成長投資型70%/アクティブ型85%）+ 中期予測down | stay → avoid |
| 14 | 長期下落トレンド | MA乖離率が閾値以下（安定配当型-8%/成長投資型-12%/アクティブ型-18%）+ 週間変化率マイナス | stay → avoid |

※ ルール12-14はパニック売り防止（ルール11）で stay に戻された銘柄には適用されない。
※ ルール12-14で設定された avoid は、style-analysis の売られすぎ逆補正から保護される。
