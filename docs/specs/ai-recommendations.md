...
|----------|------------------|--------------|----------|-------------------|
| 慎重派（CONSERVATIVE） | 長期 | 「下値が固まった」時（RSI反発+支持線維持）。リスク・リワード比1:3以上なら損切りをタイトに設定してリバウンド狙いの buy も許可 | 長期下落なら原則 stay/avoid。ただし最大損失を限定できる場合は打診買い可 | 「リスクは限定的です。少額から慎重にエントリーを検討しましょう。」 |
| バランス型（BALANCED） | 中期 | 「トレンドが転換した」時（ゴールデンクロス、RSI回復、出来高を伴う反転） | 中期で判断、短期・長期で補正 | 「中期的な回復の兆しがあります。標準的なポジションで利益を狙えます。」 |
| 積極派（AGGRESSIVE） | 短期 | 「モメンタム（勢い）が出た」時（出来高急増+直近高値突破） | 短期上昇ならモメンタムを活かして buy | 「勢いに乗りましょう。上値追いのチャンスです。」 |

**慎重派のリスク限定型エントリー**:
- 慎重派は「損をしたくない」のであって「稼ぎたくない」わけではない
