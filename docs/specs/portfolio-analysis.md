...
| 中長期上昇時のsell抑制 | スタイル別: 慎重派は長期upのみ保護、バランスは中期or長期up、積極派は保護なし（損失 > -15%の場合のみ） | sell → hold に変更 |
...
| スタイル | 判断傾向 |
|----------|----------|
| 慎重派（CONSERVATIVE） | 早めの売却目標・狭い撤退ライン、suggestedSellPercent は高め（75-100%） |
| バランス型（BALANCED） | 中期トレンドで判断、部分売却でバランスを取る |
