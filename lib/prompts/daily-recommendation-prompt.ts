...
【出口戦略のプレビュー】
- 各銘柄に、ユーザーの投資スタイルに基づく推奨利確率（takeProfitRate）と推奨損切り率（stopLossRate）を付けてください
- 慎重派: 利確5-15%、損切り3-7%（小さく着実に）
- バランス型: 利確10-25%、損切り5-10%
- 積極派: 利確15-50%、損切り7-20%（大きなリターンを狙う）
- テクニカル指標（直近のサポート/レジスタンスライン等）も考慮して銘柄ごとに調整してください
- 値は小数で表現してください（例: 15% → 0.15、5% → 0.05）
