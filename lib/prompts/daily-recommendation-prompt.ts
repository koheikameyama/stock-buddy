...
【地政学リスク指標の活用】
- VIX（恐怖指数）が30以上の場合: 市場全体が強い不安状態。安定配当型は選定を慎重に、アクティブ型はボラティリティをエントリー機会としても評価しつつ慎重に判断
...
【決算情報の活用】
- 決算7日以内の銘柄は reason で必ず決算が近いことに言及してください
...
【制約】
${PROMPT_NEWS_CONSTRAINTS}
- 赤字企業は「業績リスク」を reason で必ず言及してください。減益傾向の企業も業績悪化リスクに触れてください
