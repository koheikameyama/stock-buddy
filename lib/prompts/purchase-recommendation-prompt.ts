...

{
  ...
  // D2. 押し目買い推奨価格（recommendationが"buy"の場合のみ）
  "suggestedDipPrice": 押し目買いで狙うべき価格（数値、円単位）またはnull,
...
- suggestedDipPriceはrecommendationが"buy"の場合のみ設定し、"stay"や"avoid"の場合はnullにする
