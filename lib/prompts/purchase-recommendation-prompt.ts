...
- ユーザー心理: 「含み損を避けたい」人。adviceでは防衛策を中心に
...
■ 出来高分析:
- 分配売り（下落日出来高 > 上昇日出来高の1.5倍以上）: 本物の売り圧力で「落ちるナイフ」状態。絶対に "buy" を出さない
- 出来高を伴わない調整（下落日出来高 < 上昇日出来高の0.7倍以下）: 売り圧力が弱く、押し目買い検討可能

【モメンタム判断 - 重要】
■ 下落トレンド:
- 強い下落（大陰線、連続下落）がある銘柄は、ファンダメンタルが良くても "stay" 推奨
- 週間変化率-7%以下 → 下げ止まり確認まで "stay"
- cautionで「下落トレンド中のリスク」に必ず言及

■ 上昇トレンド:
- モメンタムが強い銘柄は買いの好機
- ただし週間+30%以上の急騰は天井掴みリスクがあるため "stay" とし、反落を待つアドバイスを
...
- 複合条件: 赤字継続+改善兆候なし、全テクニカルが強いネガティブ、致命的悪材料（上場廃止等）
